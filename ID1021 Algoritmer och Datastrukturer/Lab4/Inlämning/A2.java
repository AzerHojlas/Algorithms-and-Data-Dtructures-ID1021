/*
    ...
    Description:    Symbol graph that uses a breadth first search algorithm that finds a way between two vertices A and B

    Dependancies:   edu.princeton.cs.algs4.In  ---------- edu.princeton.cs.algs4.StdIn

    Compilation:    javac -cp .:algs4.jar A2.java

    Execution:      java -cp .:algs4.jar A2 INPUT.txt DELIMITER
...
public class A2 {
    ...
    public A2 (String stream, String sp) { 
    ...
    public static void main(String[] args)  {
        ...
        A2 symbolGraph = new A2(filename, delim);   
