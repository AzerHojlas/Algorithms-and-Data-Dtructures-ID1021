public class DirectedBreadthFirstPaths {
    ...
    // Constructor with int graph and source vertex
    public DirectedBreadthFirstPaths(A6 graph, int s)    {       
    ...
    private void bfs(A6 graph, int s) {                // Organize all vertices with shortest path

        Queue<Integer> queue = new Queue<Integer>();    // Instantiate a queue
    ...
    public boolean hasPathTo(int v) {return marked[v];} // If v can be visited from the vertex source, 
